...
\caption{Data types supported by the \texttt{.bsvx} file specification.}
...
\begin{figure}[htp]
\centering
\includegraphics[width=5in]{figures/data_to_bsvx.png}
...
\begin{figure}[htp]
\centering
\includegraphics[width=5in]{figures/bsvx_to_data.png}
